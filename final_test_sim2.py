...
#     print(total_cars_passed,total_cars_stoped)
   
#     cars_passed_text = f"total cars passed: {total_cars_passed}"
#     cars_passed_ = font.render(cars_passed_text, True, (250, 250, 250))
#     screen.blit(cars_passed_, (10, 100))
    
#     cars_stopped_text = f"total cars stoped: {total_cars_stoped}"
#     cars_stopped_ = font.render(cars_stopped_text, True, (250, 250, 250))
#     screen.blit(cars_stopped_, (10, 120))
